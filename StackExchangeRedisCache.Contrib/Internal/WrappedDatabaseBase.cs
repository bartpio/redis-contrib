...
internal abstract class WrappedDatabaseBase(IDatabase db) : IDatabase
{
    ...
    {
        return db.ExecuteAsync(command, args, flags);
    }
    ...
    {
        return db.GeoAddAsync(key, longitude, latitude, member, flags);
    }

    public Task<bool> GeoAddAsync(RedisKey key, GeoEntry value, CommandFlags flags = CommandFlags.None)
    {
        return db.GeoAddAsync(key, value, flags);
    }

    public Task<long> GeoAddAsync(RedisKey key, GeoEntry[] values, CommandFlags flags = CommandFlags.None)
    {
        return db.GeoAddAsync(key, values, flags);
    }
    ...
    {
        return db.GeoDistanceAsync(key, member1, member2, unit, flags);
    }
    ...
    {
        return db.GeoHashAsync(key, members, flags);
    }

    public Task<string?> GeoHashAsync(RedisKey key, RedisValue member, CommandFlags flags = CommandFlags.None)
    {
        return db.GeoHashAsync(key, member, flags);
    }
    ...
    {
        return db.GeoPositionAsync(key, members, flags);
    }

    public Task<GeoPosition?> GeoPositionAsync(RedisKey key, RedisValue member, CommandFlags flags = CommandFlags.None)
    {
        return db.GeoPositionAsync(key, member, flags);
    }
    ...
    {
        return db.GeoRadiusAsync(key, member, radius, unit, count, order, options, flags);
    }
    ...
    {
        return db.GeoRadiusAsync(key, longitude, latitude, radius, unit, count, order, options, flags);
    }
    ...
    {
        return db.GeoRemoveAsync(key, member, flags);
    }
    ...
    {
        return db.GeoSearch(key, member, shape, count, demandClosest, order, options, flags);
    }
    ...
    {
        return db.GeoSearch(key, longitude, latitude, shape, count, demandClosest, order, options, flags);
    }
    ...
    {
        return db.GeoSearchAndStore(sourceKey, destinationKey, member, shape, count, demandClosest, order, storeDistances, flags);
    }
    ...
    {
        return db.GeoSearchAndStore(sourceKey, destinationKey, longitude, latitude, shape, count, demandClosest, order, storeDistances, flags);
    }
    ...
    {
        return db.GeoSearchAndStoreAsync(sourceKey, destinationKey, member, shape, count, demandClosest, order, storeDistances, flags);
    }
    ...
    {
        return db.GeoSearchAndStoreAsync(sourceKey, destinationKey, longitude, latitude, shape, count, demandClosest, order, storeDistances, flags);
    }
    ...
    {
        return db.GeoSearchAsync(key, member, shape, count, demandClosest, order, options, flags);
    }
    ...
    {
        return db.GeoSearchAsync(key, longitude, latitude, shape, count, demandClosest, order, options, flags);
    }
    ...
    {
        return db.HashFieldExpire(key, hashFields, expiry, when, flags);
    }
    ...
    {
        return db.HashFieldExpireAsync(key, hashFields, expiry, when, flags);
    }
    ...
    {
        return db.HashGetLeaseAsync(key, hashField, flags);
    }
    ...
    {
        return db.HashScanNoValues(key, pattern, pageSize, cursor, pageOffset, flags);
    }
    ...
    {
        return db.HashScanNoValuesAsync(key, pattern, pageSize, cursor, pageOffset, flags);
    }
    ...
    {
        return db.HashStringLengthAsync(key, hashField, flags);
    }
    ...
    {
        return db.KeyCopy(sourceKey, destinationKey, destinationDatabase, replace, flags);
    }
    ...
    {
        return db.KeyCopyAsync(sourceKey, destinationKey, destinationDatabase, replace, flags);
    }
    ...
    {
        return db.KeyExistsAsync(keys, flags);
    }
    ...
    {
        return db.KeyExpire(key, expiry, when, flags);
    }
    ...
    {
        return db.KeyExpireAsync(key, expiry, when, flags);
    }
    ...
    {
        return db.KeyIdleTimeAsync(key, flags);
    }
    ...
    {
        return db.ListLeftPop(keys, count, flags);
    }
    ...
    {
        return db.ListLeftPushAsync(key, values, when, flags);
    }
    ...
    {
        return db.ListMove(sourceKey, destinationKey, sourceSide, destinationSide, flags);
    }
    ...
    {
        return db.ListMoveAsync(sourceKey, destinationKey, sourceSide, destinationSide, flags);
    }
    ...
    {
        return db.ListPosition(key, element, rank, maxLength, flags);
    }
    ...
    {
        return db.ListPositionAsync(key, element, rank, maxLength, flags);
    }
    ...
    {
        return db.ListPositions(key, element, count, rank, maxLength, flags);
    }
    ...
    {
        return db.ListPositionsAsync(key, element, count, rank, maxLength, flags);
    }
    ...
    {
        return db.ListRightPop(keys, count, flags);
    }
    ...
    {
        return db.ListRightPushAsync(key, values, when, flags);
    }
    ...
    {
        return db.ScriptEvaluateReadOnly(script, keys, values, flags);
    }
    ...
    {
        return db.ScriptEvaluateReadOnly(hash, keys, values, flags);
    }
    ...
    {
        return db.ScriptEvaluateReadOnlyAsync(script, keys, values, flags);
    }
    ...
    {
        return db.ScriptEvaluateReadOnlyAsync(hash, keys, values, flags);
    }
    ...
    {
        return db.SetContains(key, values, flags);
    }
    ...
    {
        return db.SetPopAsync(key, count, flags);
    }
    ...
    {
        return db.SortedSetAddAsync(key, member, score, when, flags);
    }
    ...
    {
        return db.SortedSetAddAsync(key, values, when, flags);
    }
    ...
    {
        return db.SortedSetCombine(operation, keys, weights, aggregate, flags);
    }
    ...
    {
        return db.SortedSetCombineAsync(operation, keys, weights, aggregate, flags);
    }
    ...
    {
        return db.SortedSetCombineWithScores(operation, keys, weights, aggregate, flags);
    }
    ...
    {
        return db.SortedSetCombineWithScoresAsync(operation, keys, weights, aggregate, flags);
    }
    ...
    {
        return db.SortedSetIntersectionLength(keys, limit, flags);
    }

    public Task<long> SortedSetIntersectionLengthAsync(RedisKey[] keys, long limit = 0, CommandFlags flags = CommandFlags.None)
    {
        return db.SortedSetIntersectionLengthAsync(keys, limit, flags);
    }
    ...
    {
        return db.SortedSetPop(keys, count, order, flags);
    }
    ...
    {
        return db.SortedSetPopAsync(key, order, flags);
    }

    public Task<SortedSetEntry[]> SortedSetPopAsync(RedisKey key, long count, Order order = Order.Ascending, CommandFlags flags = CommandFlags.None)
    {
        return db.SortedSetPopAsync(key, count, order, flags);
    }
    ...
    {
        return db.SortedSetRandomMembersWithScoresAsync(key, count, flags);
    }
    ...
    {
        return db.SortedSetRangeAndStore(sourceKey, destinationKey, start, stop, sortedSetOrder, exclude, order, skip, take, flags);
    }
    ...
    {
        return db.SortedSetRangeAndStoreAsync(sourceKey, destinationKey, start, stop, sortedSetOrder, exclude, order, skip, take, flags);
    }
    ...
    {
        return db.SortedSetRangeByValueAsync(key, min, max, exclude, order, skip, take, flags);
    }
    ...
    {
        return db.SortedSetUpdate(key, member, score, when, flags);
    }
    ...
    {
        return db.SortedSetUpdate(key, values, when, flags);
    }
    ...
    {
        return db.SortedSetUpdateAsync(key, member, score, when, flags);
    }
    ...
    {
        return db.SortedSetUpdateAsync(key, values, when, flags);
    }
    ...
    {
        return db.StreamAutoClaim(key, consumerGroup, claimingConsumer, minIdleTimeInMs, startAtId, count, flags);
    }
    ...
    {
        return db.StreamAutoClaimAsync(key, consumerGroup, claimingConsumer, minIdleTimeInMs, startAtId, count, flags);
    }
    ...
    {
        return db.StreamAutoClaimIdsOnly(key, consumerGroup, claimingConsumer, minIdleTimeInMs, startAtId, count, flags);
    }
    ...
    {
        return db.StreamAutoClaimIdsOnlyAsync(key, consumerGroup, claimingConsumer, minIdleTimeInMs, startAtId, count, flags);
    }
    ...
    {
        return db.StreamClaimAsync(key, consumerGroup, claimingConsumer, minIdleTimeInMs, messageIds, flags);
    }
    ...
    {
        return db.StreamClaimIdsOnlyAsync(key, consumerGroup, claimingConsumer, minIdleTimeInMs, messageIds, flags);
    }
    ...
    {
        return db.StreamConsumerGroupSetPositionAsync(key, groupName, position, flags);
    }
    ...
    {
        return db.StreamConsumerInfoAsync(key, groupName, flags);
    }
    ...
    {
        return db.StreamCreateConsumerGroupAsync(key, groupName, position, flags);
    }
    ...
    {
        return db.StreamCreateConsumerGroupAsync(key, groupName, position, createStream, flags);
    }
    ...
    {
        return db.StreamDeleteConsumerAsync(key, groupName, consumerName, flags);
    }
    ...
    {
        return db.StreamDeleteConsumerGroupAsync(key, groupName, flags);
    }
    ...
    {
        return db.StreamGroupInfoAsync(key, flags);
    }
    ...
    {
        return db.StreamInfoAsync(key, flags);
    }
    ...
    {
        return db.StreamLengthAsync(key, flags);
    }
    ...
    {
        return db.StreamPendingAsync(key, groupName, flags);
    }
    ...
    {
        return db.StreamRangeAsync(key, minId, maxId, count, messageOrder, flags);
    }
    ...
    {
        return db.StreamReadAsync(key, position, count, flags);
    }
    ...
    {
        return db.StreamReadAsync(streamPositions, countPerStream, flags);
    }
    ...
    {
        return db.StreamReadGroupAsync(streamPositions, groupName, consumerName, countPerStream, flags);
    }
    ...
    {
        return db.StreamReadGroupAsync(streamPositions, groupName, consumerName, countPerStream, noAck, flags);
    }
    ...
    {
        return db.StringBitCount(key, start, end, indexType, flags);
    }
    ...
    {
        return db.StringBitCountAsync(key, start, end, indexType, flags);
    }
    ...
    {
        return db.StringBitPosition(key, bit, start, end, indexType, flags);
    }
    ...
    {
        return db.StringBitPositionAsync(key, bit, start, end, indexType, flags);
    }
    ...
    {
        return db.StringGetDeleteAsync(key, flags);
    }
    ...
    {
        return db.StringGetLeaseAsync(key, flags);
    }
    ...
    {
        return db.StringGetSetExpiry(key, expiry, flags);
    }
    ...
    {
        return db.StringGetSetExpiryAsync(key, expiry, flags);
    }
    ...
    {
        return db.StringLongestCommonSubsequence(first, second, flags);
    }
    ...
    {
        return db.StringLongestCommonSubsequenceAsync(first, second, flags);
    }

    public long StringLongestCommonSubsequenceLength(RedisKey first, RedisKey second, CommandFlags flags = CommandFlags.None)
    {
        return db.StringLongestCommonSubsequenceLength(first, second, flags);
    }
    ...
    {
        return db.StringLongestCommonSubsequenceLengthAsync(first, second, flags);
    }
    ...
    {
        return db.StringLongestCommonSubsequenceWithMatches(first, second, minLength, flags);
    }
    ...
    {
        return db.StringLongestCommonSubsequenceWithMatchesAsync(first, second, minLength, flags);
    }
    ...
    {
        return db.StringSetAndGet(key, value, expiry, when, flags);
    }
    ...
    {
        return db.StringSetAndGetAsync(key, value, expiry, when, flags);
    }
    ...
    {
        return db.StringSetAndGetAsync(key, value, expiry, keepTtl, when, flags);
    }

    public Task<bool> StringSetAsync(RedisKey key, RedisValue value, TimeSpan? expiry, When when)
    {
        return db.StringSetAsync(key, value, expiry, when);
    }
